...
%=================================================================================
For the implementation of the tower damper in the \gls{SLOW}-model the tower equivalent bending stiffness $k_\textnormal{Te}$ and the initial tower top deflection $X_\textnormal{T0}$ is needed. 
